...
/*
 * Minimal ACPI exposure for the Winbond/Nuvoton W83667HG-A family. The LDN
 * layout matches the DQ67SW wiring and is compatible with boards that ship the
 * W83677HG-i variant.
 */

#undef SUPERIO_CHIP_NAME
#define SUPERIO_CHIP_NAME W83667HG_A
...
Device(SUPERIO_DEV) {
        ...
        Name (_STR, Unicode("Winbond W83667HG-A Super I/O"))
